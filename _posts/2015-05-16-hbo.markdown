				...
				function load_image(){
					jQuery(".image.notLoaded").each(function(){
						...
						if(bottom > wtop && top < wbottom){
							$this.attr("src",$this.data("src")).removeAttr("data-src").ready(function(){
								$this.removeClass("notLoaded").attr("sizes",$this.data("sizes")).removeAttr("data-sizes").attr("srcset",$this.data("srcset")).removeAttr("data-srcset").css('position','static').parent().css({'padding-top':'0px','height':'auto'});
							});
						}
					});
				}
